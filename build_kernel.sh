...
#cubebone kernel compile script : Nexus 7 (korean)
...
export ARCH=arm
export SUBARCH=arm
export CROSS_COMPILE=/home/youngbin/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-



echo "다음과 같은 명령을 실행하는중 : make cubebone_nexus7_defconfig" 
echo "------------------------------------------------"
sleep 5

make cubebone_nexus7_defconfig
